...
- [x] **R-024:** One verified enthusiast account and one verified administrator account are ready for the reviewer, with credentials transmitted outside source control.
